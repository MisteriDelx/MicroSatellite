...
String inputString = "";         // cadena para guardar los datos que entran
bool stringComplete = false;  // cuando la cadena está completa
///////////////////////////////////////////////////////
...
File archivo;     // objeto archivo del tipo File para lector de tarjetas microSD
 ...
 void setup(){
  pinMode( 8, OUTPUT); //pin para conectar LED de verificación de comunicaciones
...
////// FUNCIÓN PARA EL SENSOR ULTRAVIOLETA  CJMCU-GUVA-S12SD/CJMCU-S12D/////////
////// Sensor ULTRAVIOLETA:  SIGNAL->A0; Vcc=5V
  ...
  Serial.print("La fotocorriente vale:");
  Serial.print(Vout);
  Serial.println("mV");
  if (Vout < 50) {
    uv = 0;
